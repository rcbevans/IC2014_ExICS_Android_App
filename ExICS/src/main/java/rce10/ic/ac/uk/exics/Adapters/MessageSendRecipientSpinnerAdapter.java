 ...
 */
public class MessageSendRecipientSpinnerAdapter extends ArrayAdapter<String> {
    private Activity context;
    private int resource;
    private String[] data;

    public MessageSendRecipientSpinnerAdapter(Activity ctx, int resource, String[] data) {
